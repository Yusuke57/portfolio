$(function () {
  ...
  // 作品クラス
  function Work(title, category, subCategory, detail, date, url, isBlank, thumb) {
    this.title = title;
  ...
  // 作品一覧
  const works = [
    new Work("STAR TRIPS", Category.Game, "OpenGLゲーム", "大学課題で初ゲーム開発", "2016-2-12", null, false, "star-trips.gif"),
    ...
    new Work("しりとり王", Category.Game, "iOS/Androidアプリ", "しりとり用単語辞典/2万DL", "2017-11-2", "https://unity-yuji.xyz/rd/shiritori.html", false, "shiritori.png"),
    new Work("GON", Category.Game, "iOSアプリ", "200以上のシンプルパズル", "2017-11-23", "https://unity-yuji.xyz/rd/gon.html", false, "gon.gif"),
    new Work("ROBOTA", Category.Game, "iOSアプリ", "唯一の有料ゲーム", "2018-1-13", "https://unity-yuji.xyz/rd/robota.html", false, "robota.gif"),
    new Work("ゆーじのUnity開発日記", Category.Web, "技術ブログ", "Unityなどの技術発信", "2018-1-27", "https://unity-yuji.xyz/", true, "unity-yuji.png"),
    new Work("シミュレーション仮説を<br>本気で考えるサイト", Category.Web, "WEBサイト", "シミュレーション仮説を解説", "2018-4-30", "http://simulation-hypothesis.info/", true, "simulation.png"),
    new Work("つくByeBuy", Category.Web, "WEBサイト", "初チーム開発/Rails", "2018-7", "https://unity-yuji.xyz/portfolio/web/tsuku-byebuy", true, "tsuku-byebuy.png"),
    new Work("Fly Beats", Category.Game, "iOS/Androidアプリ", "リズム × STG", "2018-8-14", "https://unity-yuji.xyz/rd/fly-beats.html", false, "fly-beats.gif"),
    new Work("ナゾライフ", Category.Web, "WEBサイト", "謎解きを不定期投稿", "2018-10-8", "http://nazolife.work/", true, "nazolife.png"),
    new Work("真夜中の<br>魔法学校の秘密", Category.Web, "WEBサイト", "大学祭有志企画サイト", "2018-10-11", "http://magical-school.site/", true, "magical-school.gif"),
    new Work("Yusuke Nakajima の<br>Portfolio", Category.Web, "ポートフォリオサイト", "このサイト", "2018-10-15", "https://yusuke57.github.io/portfolio/", true, "portfolio.png"),
    new Work("元号消し", Category.Game, "iOSアプリ", "2019-5-1", "令和初日にリリース", "https://unity-yuji.xyz/rd/fall-era.html", false, "fall-era.gif"),
    new Work("しりとり王2", Category.Game, "iOSアプリ", "しりとり王をSwiftで開発", "2019-7-4", "https://unity-yuji.xyz/rd/shiritori-2.html", false, "shiritori-2.png"),
    new Work("LIFE GAME<br>-ライフゲーム-", Category.Game, "iOS/Androidアプリ", "大学課題で作成", "2019-7-4", "https://unity-yuji.xyz/rd/life-game.html", false, "life-game.gif"),
    new Work("縛りしりとり", Category.Game, "iOS/Androidアプリ", "条件付きしりとりで遊べる", "2019-8-8", "https://unity-yuji.xyz/rd/shibari-shiritori.html", false, "shibari-shiritori.png"),
    new Work("Lights On", Category.Game, "iOS/Androidアプリ", "綺麗なデザインに注力", "2019-9-26", "https://unity-yuji.xyz/rd/lights-on.html", false, "lights-on.gif"),
    new Work("約束のネバーランド<br>考察INFO", Category.Web, "WEBサイト", "漫画『約ネバ』考察", "2019-9-30", "http://the-promised-neverland.info/", true, "prom-neverland.png"),
